          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
            ...
            <div className="bg-slate-800 p-8 rounded-xl border border-slate-700">
              ...
              <div className="space-y-4 text-slate-300 leading-relaxed">
                <p>
                  <strong className="text-slate-100">Developers:</strong> Owners and employers preparing to award contracts for commercial or residential projects
                </p>
                <p>
                  <strong className="text-slate-100">Development Managers:</strong> Teams coordinating multiple packages and needing tighter risk control before award
                </p>
                <p>
                  <strong className="text-slate-100">Investor-Led Projects:</strong> Private investors and family offices requiring an independent contract risk review
                </p>
              </div>
            </div>
          </div>
